...
Видео гайд, в котором рассказывается про нюансы второй программы: https://youtu.be/iqc11rC2rr0

Для всех:
1. Установите Python 3.11 (https://www.npackd.org/p/org.python.Python64/3.11), отметьте **Add Python to PATH** при установке.
...
Путь к приложениям не должен содержать русских символов
